...
- [internal/services/cache_service.go](https://github.com/songloft-org/songloft/blob/main/internal/services/cache_service.go) -- 缓存核心结构、LRU 淘汰、配置管理
- [internal/services/cache_service_song.go](https://github.com/songloft-org/songloft/blob/main/internal/services/cache_service_song.go) -- 歌曲级缓存操作、inflight 去重、cache key 计算
- [internal/services/cache_service_transcode.go](https://github.com/songloft-org/songloft/blob/main/internal/services/cache_service_transcode.go) -- 转码缓存、ffmpeg 调用、格式映射
- [internal/handlers/cache.go](https://github.com/songloft-org/songloft/blob/main/internal/handlers/cache.go) -- 缓存管理 API handler
- [internal/handlers/hls.go](https://github.com/songloft-org/songloft/blob/main/internal/handlers/hls.go) -- HLS 电台反代、m3u8 改写引擎
- [internal/handlers/proxy.go](https://github.com/songloft-org/songloft/blob/main/internal/handlers/proxy.go) -- 通用资源代理、CORS 绕过
- [internal/services/whitelist.go](https://github.com/songloft-org/songloft/blob/main/internal/services/whitelist.go) -- SSRF 防护、内网封禁
- [internal/services/file_move.go](https://github.com/songloft-org/songloft/blob/main/internal/services/file_move.go) -- 跨设备文件移动
- [internal/httputil/proxy.go](https://github.com/songloft-org/songloft/blob/main/internal/httputil/proxy.go) -- 全局出站 HTTP 代理配置
- [internal/handlers/jsplugin_registry.go](https://github.com/songloft-org/songloft/blob/main/internal/handlers/jsplugin_registry.go) -- HTTP Proxy 设置端点
