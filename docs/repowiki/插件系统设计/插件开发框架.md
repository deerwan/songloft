...
- [internal/jsplugin/api_bridge.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/api_bridge.go) -- 宿主 API 桥接（bootstrap JS + BridgeHandler 分发）
- [internal/jsplugin/api_bridge_command.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/api_bridge_command.go) -- 命令执行桥接（exec/start/stop/download）
- [internal/jsplugin/api_bridge_fs.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/api_bridge_fs.go) -- 文件系统桥接（music:// 协议、外部路径）
- [internal/jsplugin/routes.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/routes.go) -- 路由注册（静态文件、API 转发、publicPaths、公共资源）
- [internal/jsplugin/permissions.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/permissions.go) -- 权限模型（声明层白名单 + 运行时校验）
- [internal/jsplugin/communication.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/communication.go) -- 插件间通信（send/call + onMessage handler）
- [internal/jsplugin/invoke.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/invoke.go) -- 内部 HTTP 调用（InvokeHTTP 绕过路由直达插件）
- [internal/jsplugin/service.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/service.go) -- 请求处理生命周期（JSService Actor 模型）
- [internal/jsplugin/manager.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/manager.go) -- 插件管理器（加载/卸载/懒加载/热重载）
- [internal/jsplugin/plugin.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/plugin.go) -- PluginManifest 结构与校验
- [internal/jsplugin/scheduler.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/scheduler.go) -- 消息调度器（Skynet 风格的消息分发）
- [internal/jsplugin/assets/common.css](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/assets/common.css) -- MD3 颜色系统与组件样式
- [internal/jsplugin/assets/common.js](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/assets/common.js) -- embed 检测 + 主题桥接 + SongloftPlugin 全局 API
- [internal/jsruntime/polyfill.go](https://github.com/songloft-org/songloft/blob/main/internal/jsruntime/polyfill.go) -- fetch polyfill（真异步 HTTP）
- [internal/jsruntime/runtime.go](https://github.com/songloft-org/songloft/blob/main/internal/jsruntime/runtime.go) -- QuickJS 运行时管理
