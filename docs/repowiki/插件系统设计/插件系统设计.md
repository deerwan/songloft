...
- [internal/jsruntime/runtime.go](https://github.com/songloft-org/songloft/blob/main/internal/jsruntime/runtime.go) -- QuickJS 运行时包装与事件循环
- [internal/jsruntime/polyfill.go](https://github.com/songloft-org/songloft/blob/main/internal/jsruntime/polyfill.go) -- JS 标准 API polyfill
- [internal/jsruntime/pendingjob.go](https://github.com/songloft-org/songloft/blob/main/internal/jsruntime/pendingjob.go) -- QuickJS 原生微任务执行
- [internal/jsplugin/manager.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/manager.go) -- 插件管理器（协调器）
- [internal/jsplugin/plugin.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/plugin.go) -- 插件模型与 Manifest 定义
- [internal/jsplugin/service.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/service.go) -- per-plugin 服务实例
- [internal/jsplugin/scheduler.go](https://github.com/songloft-org/songloft/blob/main/internal/jsplugin/scheduler.go) -- 消息调度器
