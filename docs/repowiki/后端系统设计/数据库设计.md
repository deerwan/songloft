...
- [internal/database/migrations/0002_*.sql](https://github.com/songloft-org/songloft/blob/main/internal/database/migrations) ~ `0025_*.sql` -- 增量迁移（含 0016 新增 plugin_storage 表）
- [internal/database/queries/*.sql](https://github.com/songloft-org/songloft/blob/main/internal/database/queries) -- sqlc 查询定义（7 文件）
