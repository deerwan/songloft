...
type Querier interface {
	...
	ListSongFacetAlbum(ctx context.Context) ([]ListSongFacetAlbumRow, error)
	ListSongFacetArtist(ctx context.Context) ([]ListSongFacetArtistRow, error)
	ListSongFacetDecade(ctx context.Context) ([]ListSongFacetDecadeRow, error)
	ListSongFacetGenre(ctx context.Context) ([]ListSongFacetGenreRow, error)
	ListSongFacetLanguage(ctx context.Context) ([]ListSongFacetLanguageRow, error)
	ListSongFacetStyle(ctx context.Context) ([]ListSongFacetStyleRow, error)
	ListSongFacetYear(ctx context.Context) ([]ListSongFacetYearRow, error)
